...
fn dump_stats() {
    let (total_cycles, normal_cycles, unsafe_cycles, external_safe_cycles, external_unsafe_cycles, unsafe_blocks, external_calls) = calculate_total_stats();
    ...
    let _ = write_output(&output, "/tmp/cpu_cycle.stat");
}